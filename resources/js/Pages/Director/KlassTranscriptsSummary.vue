<template>
    <AdminLayout title="成績總表" :breadcrumb="breadcrumb">
        ...
        <div class="py-5">
            <KlassSelector routePath="director.klass.transcripts" :param="{type:'summary'}" :currentKlass="klass"/>
        </div>
