        ...
        <div class="py-12">
            <div class="mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <a-divider type="vertical" />
                    <a :href="route('director.pre.klass.theme',{klass:klass.id,theme:selectedThemeId,format:'pdf'})" class="ant-btn" target="_blank">所選主題所有學生</a>
                    <a-divider type="vertical" />
                                ...
                                <td>
                                    <template v-for="theme in klass.themes">
                                        <span v-if="theme.id==selectedThemeId">
                                            <a :href="route('director.pre.klassStudent.theme',{klassStudent:ksid,theme:theme.id,format:'pdf'},)" target="_blank">Pdf</a>
                                        </span>
                                    </template>
...
export default {
    ...
    methods: {
        ...
        saveAbilities(){
            ...
            axios.post   (route('director.pre.klass.abilities.update',this.klass.id),data)
                .then(resp=> 
        ...
        onImport(e){
            ...
            this.$inertia.post(route('director.pre.klass.ability.import',this.klass.id),{
