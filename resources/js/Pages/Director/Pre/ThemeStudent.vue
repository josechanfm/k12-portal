        ...
        <div class="py-12">
            <div class="mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <a-divider type="vertical" />
                    <a :href="route('director.pre.klass.abilities.pdf',klass.id)" class="ant-btn">報告by Theme</a>
                    <a-divider type="vertical" />
                    <a :href="route('director.pre.klass.abilities.pdf',klass.id)" class="ant-btn">報告</a>
                                ...
                                <td>
                                    <template v-for="theme in klass.themes">
                                        <span v-if="theme.id==selectedThemeId">
                                            <a :href="route('director.pre.klassStudent.theme',{klassStudent:ksid,theme:theme.id})" target="_blank">Pdf</a>
                                        </span>
                                    </template>
