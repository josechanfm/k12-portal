<template>
    <AdminLayout title="Dashboard">
        ...
        <a-button @click="onClickCreate()" type="primary">新增職員</a-button>
            <a-table :dataSource="staffs.data" :columns="columns" :pagination="pagination" @change="onPaginationChange" ref="dataTable">
...
export default {
    ...
    methods: {
        onPaginationChange(page, filters, sorter){
            this.$inertia.get(route('admin.staffs.index'),{
                page:page.current,
        ...
        updateRecord(){
            this.$refs.modalRef.validateFields().then(()=>{
                this.$inertia.put(route('admin.staffs.update',this.modal.data.id), this.modal.data,{
                    onSuccess:(page)=>{
                        this.modal.data={}
                        this.modal.isOpen=false;
                    },
        ...
        storeRecord(){
            this.$refs.modalRef.validateFields().then(()=>{
                this.$inertia.post(route('admin.staffs.store'), this.modal.data,{
                    onSuccess:(page)=>{
                        this.modal.data={}
                        this.modal.isOpen=false;
                    },
