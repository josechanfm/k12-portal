...
<AdminLayout title="老師主控台" :breadcrumb="breadcrumb">
    <div class="">
        ...
        <a-tabs animated  v-model:activeKey="activeKey" type="card">
        ...
        <div class="bg-white rounded-lg p-1">
            <TransitionGroup>
                <div class="tborder m-2" v-if="activeKey=='1'">
                        <table id="dataTable">
                                    <thead class="">
                                        <tr>
                                            <th>班級代號</th>
                                    ...
                                    <tbody class="">
                                        <template v-for="course in staff.courses">
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <div v-for="head in course.klass.klass_heads">{{ head.name_zh }}</div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                                        <div v-for="head in course.subject_heads">{{ head.name_zh }}</div>
                                                    </div>
                                                </td>
                                                ...
                                                <td >
                                                    <div class="flex gap-1 items-center justify-center">
                                                        ...
                                                        <a-button @click="course.operation=!course.operation" size="small" type="info">更多...</a-button>
                                                    </div>
                                                </td>
                                            </tr>
                ...
                <div class="tborder m-2" v-if="activeKey=='2'">
                        <div class="">
                                ...
                                <tbody class="">
                                    <template v-for="klass in staff.headKlasses">
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <div v-for="staff in klass.klass_heads">
                                                        {{staff.name_zh}}
                                                    </div>
                                                </div>
                                            </td>
                ...
                <div class="tborder m-2" v-if="activeKey=='3'">
                                ...
                                <tbody class="">
                                    <template v-for="course in staff.headSubjects">
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <div v-for="staff in course.klass.klass_heads">
                                                        {{staff.name_zh}}
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <div v-for="staff in course.teaching">
                                                        {{staff.name_zh}}
                                                    </div>
                                                </div>
                                            </td>
