...
class AdditiveController extends Controller
{
    ...
    public function scope(Klass $klass, $category){
        ...
        return Inertia::render('Director/Pre/KlassAdditives',[
            'scopeCategory'=>ucfirst($category),
            'klass'=>$klass,
    ...
    public function page(Klass $klass){
        ...
        // dd($courses);
        return Inertia::render('Director/Pre/KlassAdditivesPage', [
            'klass' => $klass,
    ...
    public function direct(Klass $klass){
        ...
        // dd($courses);
        return Inertia::render('Director/Pre/KlassAdditivesDirect', [
            'klass' => $klass,
            'additives'=>$klass->additives(),
            'additiveGroups'=>Config::item('additive_groups')
        ]);
