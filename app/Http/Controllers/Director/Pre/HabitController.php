...
class HabitController extends Controller
{
    ...
    public function klass(Klass $klass){
        ...
        return Inertia::render('Director/Pre/KlassHabits',[
            'klass'=>$klass,
            'yearTerms'=>$terms,
    ...
    //     return Inertia::render('Director/Habit',[
    //         'klass'=>$klass,
    //         'terms'=>$terms,
    //         'habitColumns'=>$habitColumns,
    //         'habits'=>$habits
    ...
    public function import(Klass $klass, Request $request){
        ...
        return Inertia::render('Director/Pre/KlassHabitsImport',[
            'klass'=>$klass,
            'importData'=>$habits[0],
        ]);
    }
    ...
    public function importConfirmed(Klass $klass, Request $request){
        ...
        return redirect()->route('director.pre.klass.habits',$klass);
    }
}
